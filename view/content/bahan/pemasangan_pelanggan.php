...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#responsive-modal">Pemasangan</button>
                    ...
                    <form  class="form-horizontal form-material" id="loginform"action="model/input_pemasangan_pelanggan.php" method="POST" >
 ...
 <?php include 'config/notif.php';?>
            ...
            if(isset($_POST['button'])){
			   ...
			   <tr>
				...
				<td><a href="index.php?p=pemasangan_detail_pelanggan&&id_pengajuan=<?php echo $data['id_pengajuan']; ?>"><span class="label label-danger">Action</span></a></td>
              </tr>
