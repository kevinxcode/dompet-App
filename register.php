    ...
    <section id="wrapper" class="login-register">
        <div class="login-box">
            <div class="white-box">
				...
				<form  class="form-horizontal form-material" id="loginform"action="model/register.php" method="POST" >
					...
					<div class="form-group ">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="hidden" name="status" value="Calon Pelanggan" required="" placeholder="no telpon">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>have an account? <a href="login.php" class="text-primary m-l-5"><b>Login</b></a></p>
                        </div>
                    </div>
                </form>
